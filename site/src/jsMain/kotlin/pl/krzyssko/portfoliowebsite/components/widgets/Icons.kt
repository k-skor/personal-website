...
@Composable
fun LinkedInIcon(modifier: Modifier = Modifier, background: CSSColorValue) {
    Svg(
        attrs = modifier
            .toAttrs {
                viewBox(0, 0, 72, 72)
...
@Composable
fun FacebookIcon(modifier: Modifier = Modifier, background: CSSColorValue) {
    Svg(
        attrs = modifier
            .toAttrs {
                viewBox(0, 0, 40, 40)
...
@Composable
fun ArrowLinkIcon(modifier: Modifier = Modifier) {
    Svg(attrs = modifier
        .toAttrs {
            viewBox(0, -960, 960, 960)
        }) {
